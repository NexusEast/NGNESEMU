...
enum Instruction:u16
{
	...
	/*1x*/	STOP,		LD_DE_D16,	LD_DE_A,		INC_DE,			INC_D,			DEC_D,		LD_D_D8,		RLA,		JR_R8,			ADD_HL_DC,		LD_A_DE,		DEC_DE,		INC_E,		DEC_E,		LD_E_D8,		RRA,
	...
	/*Ex*/	LDH_A8ADR_A,POP_HL,		LD_CADR_A,		BADOP_2,		BADOP_10,		PUSH_HL,	AND_D8,			RST_20H,	ADD_SP_R8,		JP_HLA,			LD_A16ADR_A,	BADOP_8,	BADOP_6,	BADOP_7,	XOR_D8,			RST_28H,
